...
void changepoint(double x, double y, double &ex, double &ey) //点反演变换
{
...
void changecircle(double x, double y, double r, double &ex, double &ey, double &er) // 圆反演变换
{
...
void rotate(double s, double t, double &aa, double &bb, double &cc, double sinct, double cosct) // 直线aax + bby = cc绕s,t点旋转ct角度，其中sin(ct) = sinct,cos(ct) = cosct
{
...
void getline(double x_1, double y_1, double r_1, double x_2, double y_2, double r_2) // 求两个圆的外公切线
{
...
void getcircle(double aa, double bb, double cc, int k) // 求直线aax + bby = cc经过反演变换后的圆
{
